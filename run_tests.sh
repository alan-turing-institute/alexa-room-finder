...
lambda-local -l lambda/index.js -h handler -e test/test-CancelIntent-State_TIMEMODE.js
...
lambda-local -l lambda/index.js -h handler -e test/test-HelpIntent-State_TIMEMODE.js
...
lambda-local -l lambda/index.js -h handler -e test/test-NoIntent-State_TIMEMODE.js
...
lambda-local -l lambda/index.js -h handler -e test/test-RepeatIntent-State_TIMEMODE.js
...
lambda-local -l lambda/index.js -h handler -e test/test-StartOverIntent-State_TIMEMODE.js
...
lambda-local -l lambda/index.js -h handler -e test/test-StopIntent-State_TIMEMODE.js
